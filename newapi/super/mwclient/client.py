...
class Site:
    ...
    def __init__(
        ...
        if consumer_token is not None:
            ...
            print(
                RuntimeError("Authentication is not a tuple or an instance of AuthBase")
            )
    ...
    def handle_api_result(self, info, kwargs=None, sleeper=None):
        ...
        if "error" in info:
            ...
            if info["error"].get(
                "code"
            ) == "mwoauth-invalid-authorization" and "Nonce already used" in info[
                "error"
            ].get(
                "info"
            ):
    ...
    def clientlogin(self, cookies=None, **kwargs):
        ...
        if kwargs:
            ...
            if status == "PASS":
                ...
                print(
                    errors.LoginError(self, status, login["clientlogin"].get("message"))
                )
